...
import { getSubjects, createSubject, getTopics, createTopic, getWorksheets, createWorksheet, deleteWorksheet, completeWorksheet, getWordOfTheDay, createWordOfTheDay, listVocabularyWords, deleteVocabularyWord, getUserDashboard, } from "../controllers/prepController.js";
...
router.post("/worksheets", authenticate, requireRole("admin"), upload.fields([
    { name: "pdf", maxCount: 1 },
    { name: "answer", maxCount: 1 },
]), createWorksheet);
router.delete("/worksheets/:id", authenticate, requireRole("admin"), deleteWorksheet);
...
router.delete("/vocabulary/:id", authenticate, requireRole("admin"), deleteVocabularyWord);
// Dashboard
