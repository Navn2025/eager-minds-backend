...
router.post("/", authenticate, requireRole("admin"), upload.single("image"), createActivity);
router.put("/:id", authenticate, requireRole("admin"), upload.single("image"), updateActivity);
