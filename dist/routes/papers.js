...
import { getPapers, getPaper, createPaper, updatePaper, deletePaper, completePaper, adminGetPapers, } from "../controllers/paperController.js";
...
router.post("/", authenticate, requireRole("admin"), upload.fields([
    { name: "pdf", maxCount: 1 },
