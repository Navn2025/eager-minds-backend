...
export declare function getAllWorksheets(req: Request, res: Response): Promise<void>;
...
export declare function updateVocabularyWord(req: Request, res: Response): Promise<void>;
